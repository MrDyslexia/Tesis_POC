    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statusWrap}>
          ...
          {/* CTA Wear: instalar motor TTS si falta */}
          {ttsError?.includes('No hay motor TTS instalado') && (<>
            ...
            <View style={styles.gmsBanner}>
              ...
              <Text style={styles.gmsBannerText}>
                Usa un reloj/emulador Wear OS con Google Play. Abre Play Store
                en el reloj y actualiza Play Services.
              </Text>
              <View style={{height: 6}} />
              <TouchableOpacity
                style={styles.gmsBtn}
        ...
        <View style={styles.mainActionContainer}>
          {(() => {
            if (!isConnected) {
              return (
                <TouchableOpacity
                  style={[styles.mainButton, styles.connectButton]}
                  onPress={connect}>
...
const styles = StyleSheet.create({
  ...
  ttsCtaText: {color: '#fff', fontSize: 12, fontWeight: '700'},
  ...
  gmsBtnText: {color: '#fff', fontSize: 12, fontWeight: '700'},
});
